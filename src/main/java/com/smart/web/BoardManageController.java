...
public class BoardManageController extends BaseController{
    ...
    public ModelAndView listBoardTopics(@PathVariable Integer boardId, @RequestParam(
            value = "pageNo", required = false) Integer pageNo) {
    ...
    @RequestMapping(value = "/board/listTopicsPosts-{topicId}", method = RequestMethod.GET)
    public ModelAndView listTopicsPosts(@PathVariable Integer topicId, @RequestParam(
            value = "pageNo", required = false) Integer pageNo) {
        ModelAndView view = new ModelAndView();
    ...
    public String makeDigestTopic(@RequestParam("topicIds") String topicIds, @RequestParam("boardId") String boardId) {
        ...
        String targetUrl = "/baord/listBoardTopics-" + boardId + ".html";
        return "redirect:" + targetUrl;
    }
}
